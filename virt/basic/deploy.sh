...
#
# rocky10:
#  CLUSTERNAME=rocky10-basic CLUSTERRAM=2048 CLUSTERVCPUS=1 IMAGENAME=rocky10 DISKSIZE=20G nVMS=1 bash deploy.sh
#
# ubuntu24.04:
...
CLUSTERRAM=${CLUSTERRAM:=2048}
CLUSTERVCPUS=${CLUSTERVCPUS:=2}
DISKSIZE=${DISKSIZE:=12G}
nVMS=${nVMS:=1}
